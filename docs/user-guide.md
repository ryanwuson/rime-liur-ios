...
- **字母鍵**：顯示該鍵的符號選單或變體選項
  ...
  <img src="images/03-4大寫變體.PNG" alt="03-4大寫變體" style="zoom:67%;" />

  

  <img src="images/03-5大寫變體.PNG" alt="03-5大寫變體" style="zoom:67%;" />

  

  <img src="images/03-6大寫變體.PNG" alt="03-6大寫變體" style="zoom: 67%;" />

  

- **空格鍵**：開啟方案選擇器，可在「蝦米輸入法」及「Easy English」間切換

  <img src="images/03-7方案選擇.PNG" alt="03-7方案選擇" style="zoom: 67%;" />

  

  <img src="images/03-8方案選擇.PNG" alt="03-8方案選擇" style="zoom: 67%;" />

  

- **123鍵**：顯示數學符號選單（+、-、×、÷、=、≠）

  <img src="images/03-9「123」.PNG" alt="03-9「123」" style="zoom: 67%;" />

- **「,」及「.」鍵**：開啟「日期時間」選單

  <img src="images/03-10「,」.PNG" alt="03-10「,」" style="zoom:67%;" />
...
##### 一般上滑及下滑功能
- **Q～P鍵下滑**：快速輸入數字1～0，若「候選字區」有候選字，也可透過下滑 Q～P 鍵來選字
...
- **Z～M鍵下滑**：分別為「句首」、「剪下」、「複製」、「貼上」、「Tab」、「全選」及「句尾」功能

- **Z、N及M鍵上滑**：分別為「單首模式」、「選擇第2候選字」及「選擇第3候選字」功能
...
<img src="images/03-19右側展開.PNG" alt="03-19右側展開" style="zoom:67%;" />



<img src="images/03-20更多候選字.PNG" alt="03-20更多候選字" style="zoom:67%;" />
...
- **操作**：輸入候選字後點擊左下角的`「同音」`或上滑L鍵輸出 `'`

- **說明**：顯示該字的同音字及其字碼，方便查找同音異字

- **注意**：簡體模式下亦可對應相關同音字，如「发」的同音字有「伐」、「瞂」及「法」。

  <img src="images/6-1同音字.png" alt="6-1同音字" style="zoom:67%;" />
