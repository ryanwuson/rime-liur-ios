...
- **安裝入門**
  - [需求與下載](/getting-started/requirements.md)
  - [啟用輸入法](/getting-started/enable-keyboard.md)
...
- **皮膚**
  ...
  - [皮膚設計器（完整說明）](https://ryanwuson.github.io/rime-liur-ios-new-skin/guide/#/)

- **元書輸入法設定**
  - [基本設定](/yuanshu-settings/basic-settings.md)
...
- **鍵盤與手勢**
  ...
  - [候選字](/daily-use/candidates.md)

- **輸入功能**
  - [基本輸入](/features/basic-input.md)
  - [造詞](/features/compose.md)
  ...
  - [無效鍵屏蔽](/features/block-invalid-keys.md)
  - [計算機](/features/calculator.md)

- **參考**
  - [快捷總表](/reference/shortcuts.md)
